...
![Lumark Banner](https://github.com/AmulyaInnovates/Lumark/blob/master/Project%20Working.mp4)
...
- `/Lumark_Showcase`: Development history, recordings, and branding assets.
...
./run.ps1
```
This will install dependencies (via `npm install`) and launch both the server and client.
...
---
**Lumark: Illuminate. Secure. Precise.**
